...
- Zen Bali Agent API page: ZENBALI_API.md
- Use the event posting API instead of browser automation.
- Zen upload skill: SKILL_ZEN_UPLOAD.md
- Event posting skill mirror: SKILL_ZEN_UPLOAD.md
